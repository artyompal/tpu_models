...
PYTHONPATH=$HOME/dev/frameworks/tensorflow_models:$HOME/dev/frameworks/tensorflow_models/research:$HOME/dev/frameworks/tensorflow_models/research/slim:$HOME/tpu_models/models
...
TRAIN_FILE_PATTERN=${STORAGE_BUCKET}/converted/$PART/train*
EVAL_FILE_PATTERN=${STORAGE_BUCKET}/converted/$PART/val*
